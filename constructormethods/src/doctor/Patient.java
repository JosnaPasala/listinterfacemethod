        ...
        do {
            ...
            switch (ch) {
                case 1:
                    ...
                    d.add(new Doctor1(pno, pname, pdisease));
                    break;
                case 2:
                    System.out.println("--------------------------");
                ...
                case 5:
                    ...
                    pnum = s.nextInt();
                    System.out.println("--------------------------");
                    ListIterator<Doctor1> li = d.listIterator();
                    while (li.hasNext()) {
                        Doctor1 d1 = li.next();
                        if (d1.getPno() == pnum) {
                            ...
                            pno = s.nextInt();
                            pdisease = s.nextLine();
                            li.set(new Doctor1(pno, pname, pdisease));                            //set method(Update the data)
                            found = true;
                ...
                case 7:
                    ...
                    break;
                case 8:
                    List<Doctor1> list = new LinkedList<>();
                    Doctor1 d1 = new Doctor1(12, "josna", "cold");
                    list.add(d1);
                    Doctor1 d2 = list.get(0);                                                                 // get method(for retrieving elements)
                    System.out.println(d2);
                    break;


                case 9:
                    List<Doctor1> s3= new LinkedList<>();
                    s3.add(new Doctor1(12,"pravali","fever"));
                    s3.add(new Doctor1(13,"josuu","cold"));
                     s3.add(new Doctor1(14,"jyothi","cough"));
                ...
                case 14:
                    ...
                    Object[] a= list4.toArray();                                            //returns the array that contains the all elements in list in proper order
                    System.out.println();
